export const original = {
  ...
  "Location": "Location",
  "MaxNumberFiles": "Uploaded file exceed the limit of {0} files per evidence. Can\u00b4t attach {1}.",
  "Name": "Name",
  "Plant": "Plant",
  "Points": "Points",
  ...
  "ThisChecklistIsNoLongerPartOfPlant": "This Checklist is no longer part of Plant: {0}",
  "TotalEvidenceExceed": "Total uploaded as evidence exceed the {0} MB limit. Can't attach {1}.",
  "TotalPoints": "Total Points",
  "WeightedAuditCapture": "Weighted Audit Capture",
  "ZeroFindings": "Zero Findings",
  "ZeroFindingsConfirmation": "Are you sure no issues were found and you want to save results as Zero Findings?",
  "Name_Profile": "Name",
  "ExplanationAndPlan": "Explanation &amp; Plan",
  "ShowPreviewsAuditsResults": "Show Previous Audits",
  "G": " [G]",
  "Continue": "Continue",
  "QuestionGroupDeletedGlobal": "This Question Group is no longer part of the Tenant: {0}",
  "QuestionGroupDeletedLocal": "This Question Group is no longer part of the Plant: {0}",
  "Done": "Done",
  "Uploading": "Uploading...",
  ...
  "Print": "Print",
  "ConfirmPrint": "Your audit will be saved as a draft before opening the print screen. Do you want to continue?",
